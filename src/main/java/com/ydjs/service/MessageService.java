...
import com.ydjs.repository.MessageRepository;
 ...
 * Responsible for handling all business logic, validation, and connecting controller requests to the database via Repositories.
 * 
 * Architectural Pattern:
 * - Service Layer (3-Layer Architecture) pattern, mediating between Controller and Repository components.
 */
@Service
public class MessageService {

    // Design Pattern: Dependency Injection. Uses both MessageRepository and AccountRepository for cross-entity validation.
     ...
     * 
     * Validation rules:
     * 1. messageText must not be null or blank.
     * 2. messageText must be under 255 characters.
     * 3. postedBy must refer to a real, existing user.
     * 
     ...
     * 
     * Validation rules:
     * 1. The message ID must exist.
     * 2. The new message text must not be blank.
