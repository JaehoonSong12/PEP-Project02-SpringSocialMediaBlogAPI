 ...
 * This exception is caught by the GlobalExceptionHandler to return an HTTP 401 Unauthorized status.
 * 
 * Architectural Pattern:
 * - Exception Handling Pattern: Custom RuntimeException for conveying authentication failures.
 */
