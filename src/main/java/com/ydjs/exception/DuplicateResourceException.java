 ...
 * (e.g., registering an account with a username that is already taken).
 * This exception is caught by the GlobalExceptionHandler to return an HTTP 409 Conflict status.
 * 
 * Architectural Pattern:
 * - Exception Handling Pattern: Custom RuntimeException for conveying unique constraint violations.
 */
